                ...
                <div className="row works-portfolio">
                    <div className="column lg-12" data-animate-block>
                        ...
                        <li className="folio-list__item column" >
                                <a className="folio-list__item-link" href="https://expense-tracker-delta-lilac.vercel.app/" target='blank'>
                                    <div className="folio-list__item-pic">
                                        <img src="https://img.freepik.com/free-photo/full-shot-people-coins_23-2151027569.jpg" alt=""/>
                                    </div>
                                    ...
                                    <div className="folio-list__item-text">
                                        ...
                                        <p>Developed a expense tracker project where we can track out transactions such as income and expenses and along with the details and we can filter it out by different categories date and month. In this project we can export our report data of your transactions while ensuring user accounts are secure and accessible. Here i have used NextJS frameworks and MaterialUI for styling along with Supabase database for the backend.
                                        </p>
                                    </div>
                                </a>
